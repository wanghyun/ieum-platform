...
$tuition_shortcut_catalog = function_exists('ieum_dashboard_shortcut_catalog') ? ieum_dashboard_shortcut_catalog() : array();
$tuition_shortcut_keys = function_exists('ieum_dashboard_get_shortcut_keys') ? ieum_dashboard_get_shortcut_keys($academy_id) : array();
$tuition_default_shortcut_keys = function_exists('ieum_dashboard_default_shortcut_keys') ? ieum_dashboard_default_shortcut_keys() : array();
...
body.ieum-dashboard-page.tuition-page-tune.ieum-dark{
    --ieum-side-bg:#111827!important;
    background:#0f1724!important;
    color:#e5edf7!important;
}
body.ieum-dashboard-page.tuition-page-tune.ieum-dark .side-sub,
body.ieum-dashboard-page.tuition-page-tune.ieum-dark .hero,
body.ieum-dashboard-page.tuition-page-tune.ieum-dark .panel,
body.ieum-dashboard-page.tuition-page-tune.ieum-dark .brief-card,
body.ieum-dashboard-page.tuition-page-tune.ieum-dark .filters,
body.ieum-dashboard-page.tuition-page-tune.ieum-dark .paymint-gate,
body.ieum-dashboard-page.tuition-page-tune.ieum-dark .settings-modal-card{
    background:#151f2e!important;
    border-color:#2c3a4f!important;
    color:#e5edf7!important;
    box-shadow:none!important;
}
body.ieum-dashboard-page.tuition-page-tune.ieum-dark th{
    background:#1b2535!important;
    color:#d9e2ef!important;
    border-color:#2c3a4f!important;
}
body.ieum-dashboard-page.tuition-page-tune.ieum-dark td{
    background:#151f2e!important;
    color:#d9e2ef!important;
    border-color:#263244!important;
}
body.ieum-dashboard-page.tuition-page-tune.ieum-dark input,
body.ieum-dashboard-page.tuition-page-tune.ieum-dark select,
body.ieum-dashboard-page.tuition-page-tune.ieum-dark textarea,
body.ieum-dashboard-page.tuition-page-tune.ieum-dark .btn{
    background:#111827!important;
    border-color:#334155!important;
    color:#e5edf7!important;
}
body.ieum-dashboard-page.tuition-page-tune.ieum-dark .primary,
body.ieum-dashboard-page.tuition-page-tune.ieum-dark .btn.primary{
...
<?php
$tuition_shortcut_js_catalog = array();
foreach ($tuition_shortcut_catalog as $shortcut_key => $shortcut_item) {
    $tuition_shortcut_js_catalog[$shortcut_key] = array(
...
(function(){
    var rootSelector = '.tuition-page-tune.ieum-dashboard-page';
    var shortcutCatalog = <?php echo json_encode($tuition_shortcut_js_catalog, JSON_UNESCAPED_UNICODE); ?>;
    var currentShortcutKeys = <?php echo json_encode(array_values($tuition_shortcut_keys), JSON_UNESCAPED_UNICODE); ?>;
    var defaultShortcutKeys = <?php echo json_encode(array_values($tuition_default_shortcut_keys), JSON_UNESCAPED_UNICODE); ?>;
    var shortcutMax = 6;
