...
.wrap{max-width:1280px;margin:28px auto;padding:0 20px}.bar{display:flex;gap:10px;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap}h1{margin:0;font-size:26px}.panel{background:#fff;border:1px solid #d9dee7;border-radius:8px;padding:22px;box-shadow:0 8px 20px rgba(15,23,42,.06)}.chips{display:flex;gap:8px;flex-wrap:wrap;margin:8px 0 16px}.chip{background:#eef2f7;border-radius:999px;padding:6px 10px;color:#344054;font-weight:700}.filters{display:flex;gap:8px;align-items:center;flex-wrap:wrap}input,select{height:38px;border:1px solid #cfd6df;border-radius:6px;padding:0 10px}.btn{display:inline-flex;align-items:center;justify-content:center;min-height:38px;border:1px solid #cfd6df;border-radius:6px;background:#fff;color:#111827;text-decoration:none;padding:8px 12px;font-weight:700;cursor:pointer}.btn.primary{background:#1769c2;border-color:#1769c2;color:#fff}.queue-table-wrap{overflow-x:auto;border:1px solid #d8dee9;border-radius:8px}table{width:100%;min-width:1120px;border-collapse:collapse;background:#fff}th,td{border:1px solid #d8dee9;padding:9px;text-align:center;font-size:14px;vertical-align:top;line-height:1.35}th{background:#72829d;color:#fff}td.left{text-align:left}.sms-table th:first-child,.sms-table td:first-child{width:52px}.sms-table th:nth-child(2),.sms-table td:nth-child(2){width:90px;white-space:nowrap}.sms-table th:nth-child(3),.sms-table td:nth-child(3){width:104px;white-space:nowrap}.sms-table th:nth-child(4),.sms-table td:nth-child(4){width:110px}.sms-table th:nth-child(5),.sms-table td:nth-child(5){width:118px;white-space:nowrap}.sms-table th:nth-child(6),.sms-table td:nth-child(6){min-width:360px}.sms-table th:nth-child(7),.sms-table td:nth-child(7),.sms-table th:nth-child(8),.sms-table td:nth-child(8){width:128px}.sms-table th:nth-child(9),.sms-table td:nth-child(9){width:112px}.status-pending{color:#9a5b00;font-weight:700}.status-processing{color:#175cd3;font-weight:700}.status-sent{color:#176b2c;font-weight:700}.status-failed{color:#a4262c;font-weight:700}.token{margin-top:16px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:12px;color:#475467}code{background:#eef2f7;border-radius:4px;padding:2px 6px}@media (max-width:900px){table{white-space:normal}.filters{align-items:stretch}.filters input{width:100%}.nav-sub{position:static}.nav-group:hover .nav-sub{display:grid}}
</style>
</head>
<body>
