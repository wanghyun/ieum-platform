    ...
    <section class="sheet">
        ...
        <section class="body">
            ...
            <article class="mission-box">
                <div>
                    <div class="section-title"><strong><?php echo get_text($mission_title); ?></strong><span>가정 실천</span></div>
                    <p><b>주제: <?php echo get_text($mission_theme); ?></b><br><?php echo get_text($mission_summary); ?></p>
                    <p><?php echo get_text($mission_report['parent_text']); ?></p>
                </div>
                <span class="mission-badge"><?php echo get_text($mission_report['status_label']); ?></span>
            </article>
