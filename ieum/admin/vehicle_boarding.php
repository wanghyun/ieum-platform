...
<main class="wrap">
    ...
    <section class="summary">
        ...
        <article class="summary-card"><span>개별</span><strong><?php echo number_format((int) $boarding_summary['self']); ?></strong></article>
    </section>
    <?php
    $current_route = '';
    $current_stop = '';
